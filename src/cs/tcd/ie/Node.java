...
public abstract class Node {
	...
	public abstract void onReceipt(DatagramPacket packet) throws IOException, Throwable;
	...
	class Listener extends Thread {
		...
		public void run() {
			...
			} catch (Exception e) {if (!(e instanceof SocketException)) e.printStackTrace();} catch (Throwable e) {
